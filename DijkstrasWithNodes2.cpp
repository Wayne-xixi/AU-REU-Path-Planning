  ...
  while(front.size()>0){
    ...
    */
    ...
    for(int i = 0; i < 6; i++){
      ...
      *//*
      vector<double> p1;
      p1.push_back(new_pos.x-0.5);
      p1.push_back(new_pos.y-0.5);
      p1.push_back(new_pos.z-0.5);
      vector<double> p2;
      p2.push_back(new_pos.x+0.5);
      p2.push_back(new_pos.y+0.5);
      p2.push_back(new_pos.z+0.5);*/
    //  Vector3 * p1 = new Vector3 (new_pos.x-0.5,new_pos.y-0.5, new_pos.z-0.5);
     // Vector3 * p2 = new Vector3* (new_pos.x+ 0.5,new_pos.y+0.5, new_pos.z+0.5);
      int occupied = 0;
