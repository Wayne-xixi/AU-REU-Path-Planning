...
int main(int argc, char** argv) {
  ...
  {
     cout << "Waypoint %d: " << i+1 << endl;
     cout << "Wait Time %d: " << waypoints[i].t << endl;
     cout << "X %d: " << waypoints[i].position(x) << endl;
     cout << "Y %d: " << waypoints[i].position(y) << endl;
     cout << "Z %d: " << waypoints[i].position(z) << endl;
     cout << "Yaw %d: " << waypoints[i].yaw << endl;
